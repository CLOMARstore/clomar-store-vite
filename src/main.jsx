...
const buildLabelsPrintHTML = ({
  ...
  const labelMarkup = ({ product }) => {
    ...
    return `<article class="label template-${safeTemplate} ${styleClass} density-${layout.density} mode-${labelPrintEsc(mode)}">${logoBlock}<div class="label-title"><div class="name">${labelPrintEsc(clipped(product?.name))}</div>${meta}</div>${priceBlock}<div class="codes ${hasQr && hasBarcode ? 'codes-both' : ''}">${qrBlock}${barcodeBlock}</div></article>`;
  };
...
<style>
  ...
  *{box-sizing:border-box} html,body{margin:0;padding:0;background:#fff;color:#000;font-family:Arial,Helvetica,sans-serif} body{print-color-adjust:exact;-webkit-print-color-adjust:exact}
  ...
  .density-compact.template-commercial{padding:1.35mm 1.35mm 1.1mm;grid-template-rows:2.95mm 6.65mm 5.45mm 10.15mm;gap:.34mm}.density-compact.template-commercial .brand{min-height:2.95mm;font-size:6.4px}.density-compact.template-commercial .brand img{width:2.7mm;height:2.7mm}.density-compact.template-commercial .label-title{height:6.65mm;display:block;overflow:hidden}.density-compact.template-commercial .name{display:block;min-height:5.05mm;max-height:5.05mm;overflow:hidden;word-break:break-word;font-size:7.45px;line-height:1.02;font-weight:950;letter-spacing:-.01em}.density-compact.template-commercial .meta{height:1.25mm;font-size:5.05px;line-height:1.05}.density-compact.template-commercial .price{min-height:5.45mm;padding:.62mm .95mm;border-radius:1.35mm;box-shadow:inset 0 -.2mm 0 rgba(255,255,255,.08)}.density-compact.template-commercial .price span{font-size:4.35px;letter-spacing:.08em}.density-compact.template-commercial .price strong{font-size:10.15px;line-height:1}.density-compact.template-commercial .codes{height:10.15mm;gap:1.02mm}.density-compact.template-commercial .qr-wrap{grid-template-columns:9.1mm;grid-template-rows:9.1mm auto}.density-compact.template-commercial .qr{width:9.1mm;height:9.1mm}.density-compact.template-commercial .qr-wrap small{display:none}.density-compact.template-commercial .barcode-wrap{grid-template-rows:7.55mm auto}.density-compact.template-commercial .barcode-svg{height:7.55mm}.density-compact.template-commercial .code-text{font-size:4.55px}.density-compact.template-commercial .codes-both .barcode-wrap{width:calc(var(--label-w) - 15.2mm)}
  ...
  @media screen{body{background:#f3f4f6;padding:12mm}.label-page{margin:0 auto 12mm;box-shadow:0 2mm 8mm rgba(15,23,42,.18)}}@media print{html,body{width:100%;height:auto;background:#fff}.label-page{box-shadow:none;margin:0}.label{border-color:#aeb5bf}.label-title{display:block!important;overflow:hidden!important}.name{display:block!important;-webkit-line-clamp:unset!important;-webkit-box-orient:initial!important;overflow:hidden!important}.density-compact.template-commercial{padding:1.25mm 1.25mm 1.05mm!important;grid-template-rows:2.85mm 6.2mm 5.15mm 9.75mm!important;gap:.26mm!important}.density-compact.template-commercial .brand{min-height:2.85mm!important;font-size:6.05px!important}.density-compact.template-commercial .brand img{width:2.55mm!important;height:2.55mm!important}.density-compact.template-commercial .label-title{height:6.2mm!important}.density-compact.template-commercial .name{min-height:4.75mm!important;max-height:4.75mm!important;font-size:7.05px!important;line-height:1.01!important}.density-compact.template-commercial .meta{height:1.1mm!important;font-size:4.75px!important}.density-compact.template-commercial .price{min-height:5.15mm!important;padding:.5mm .8mm!important}.density-compact.template-commercial .price strong{font-size:9.45px!important}.density-compact.template-commercial .price span{font-size:4.15px!important}.density-compact.template-commercial .codes{height:9.75mm!important;gap:.9mm!important}.density-compact.template-commercial .qr-wrap{grid-template-columns:8.8mm!important;grid-template-rows:8.8mm auto!important}.density-compact.template-commercial .qr{width:8.8mm!important;height:8.8mm!important}.density-compact.template-commercial .barcode-wrap{grid-template-rows:7.1mm auto!important}.density-compact.template-commercial .barcode-svg{height:7.1mm!important}.density-compact.template-commercial .code-text{font-size:4.35px!important}.density-compact.template-commercial .codes-both .barcode-wrap{width:calc(var(--label-w) - 14.8mm)!important}}
