...
@media print{.price strong{white-space:nowrap!important}.composition-two-column .price strong{white-space:nowrap!important}.composition-two-column.price-max .price strong{font-size:13.1px!important}.label.orientation-vertical.vertical-compact{grid-template-rows:4mm 14mm 11mm 28mm!important;gap:.7mm!important;align-content:start!important}.label.orientation-vertical.vertical-compact .codes{height:28mm!important;align-items:start!important}.label.orientation-vertical.vertical-compact .barcode-wrap{grid-template-rows:17mm auto!important}.label.orientation-vertical.vertical-compact .barcode-svg{height:17mm!important}.label.orientation-vertical.price-max .price strong{font-size:22px!important}.qr-large .qr-wrap{grid-template-columns:12.4mm!important;grid-template-rows:12.4mm auto!important}.qr-large .qr{width:12.4mm!important;height:12.4mm!important}.qr-max .qr-wrap{grid-template-columns:16mm!important;grid-template-rows:16mm auto!important}.qr-max .qr{width:16mm!important;height:16mm!important}}
...
const LABEL_VISUAL_PRESETS = {
  ...
  ropa_colgante: { label: 'Ropa colgante', help: 'Vertical, precio claro y barras POS para prendas.', labelUse: 'apparel', orientation: 'vertical', composition: 'classic', mode: 'barcode', labelTemplate: 'commercial', sheetLayout: 'a4_vertical_3x3', priceEmphasis: 'max', qrEmphasis: 'small', verticalDensity: 'compact' },
