...
<style>
  ...
  *{box-sizing:border-box} html,body{margin:0;padding:0;background:#fff;color:#000;font-family:Arial,Helvetica,sans-serif} body{print-color-adjust:exact;-webkit-print-color-adjust:exact}
  ...
  .density-compact.template-commercial{padding:1.05mm 1.1mm .9mm;grid-template-rows:2.5mm 5.9mm 5mm 9.2mm;gap:.24mm}.density-compact.template-commercial .brand{min-height:2.5mm;font-size:5.8px}.density-compact.template-commercial .brand img{width:2.4mm;height:2.4mm}.density-compact.template-commercial .label-title{height:5.9mm}.density-compact.template-commercial .name{height:4.55mm;max-height:4.55mm;font-size:6.55px;line-height:1.04}.density-compact.template-commercial .meta{height:1.05mm;font-size:4.7px}.density-compact.template-commercial .price{min-height:5mm;padding:.45mm .8mm}.density-compact.template-commercial .price span{font-size:4.1px}.density-compact.template-commercial .price strong{font-size:8.7px}.density-compact.template-commercial .codes{height:9.2mm;gap:.8mm}.density-compact.template-commercial .qr-wrap{grid-template-columns:8.5mm;grid-template-rows:8.5mm auto}.density-compact.template-commercial .qr{width:8.5mm;height:8.5mm}.density-compact.template-commercial .qr-wrap small{display:none}.density-compact.template-commercial .barcode-wrap{grid-template-rows:6.9mm auto}.density-compact.template-commercial .barcode-svg{height:6.9mm}.density-compact.template-commercial .code-text{font-size:4.2px}.density-compact.template-commercial .codes-both .barcode-wrap{width:calc(var(--label-w) - 14.3mm)}
